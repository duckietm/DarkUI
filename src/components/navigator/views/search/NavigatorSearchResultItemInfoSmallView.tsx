...
export const NavigatorSearchResultItemInfoSmallView: FC<NavigatorSearchResultItemInfoViewProps> = props =>
{
    ...
    return (
        <>
            <Base innerRef={ elementRef } onMouseOver={ event => setIsVisible(true) } onMouseLeave={ event => setIsVisible(false) }>
                <img style={{height: "25px", cursor: "pointer", objectFit: "contain"}} src="https://1.bp.blogspot.com/-aQdrzEzzCS8/X5js-ezc3PI/AAAAAAABemk/DugG7FpFJFYQrRyf9y4qPjMv_WnTLv3zACPcBGAsYHg/s0/ui_navigator_icon_roominfo.png" />
            </Base>
