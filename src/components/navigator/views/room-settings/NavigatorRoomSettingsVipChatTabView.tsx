...
export const NavigatorRoomSettingsVipChatTabView: FC<NavigatorRoomSettingsTabViewProps> = props =>
{
    ...
    return (
        <>
            <Column gap={ 1 }>
                <Text variant="white"  bold>{ LocalizeText('navigator.roomsettings.vip.caption') }</Text>
                <Text variant="white" >{ LocalizeText('navigator.roomsettings.vip.info') }</Text>
            </Column>
            <Grid overflow="auto">
                <Column size={ 6 } gap={ 1 }>
                    <Text variant="white"  bold>{ LocalizeText('navigator.roomsettings.chat_settings') }</Text>
                    ...
                    <Text variant="white" >{ LocalizeText('navigator.roomsettings.chat_settings.hearing.distance') }</Text>
                ...
                <Column size={ 6 } gap={ 1 }>
                    <Text variant="white"  bold>{ LocalizeText('navigator.roomsettings.vip_settings') }</Text>
