    ...
    return (
        <>
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="white" className="col-3">{ LocalizeText('navigator.roomname') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="white" className="col-3">{ LocalizeText('navigator.roomsettings.desc') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="white" className="col-3">{ LocalizeText('navigator.category') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="white" className="col-3">{ LocalizeText('navigator.maxvisitors') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="white" className="col-3">{ LocalizeText('navigator.tradesettings') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="white" className="col-3">{ LocalizeText('navigator.tags') }</Text>
                <Column fullWidth gap={ 0 }>
            ...
            <Text variant="white" underline bold pointer className="d-flex justify-content-center align-items-center gap-1" onClick={ deleteRoom }>
