...
export const NavigatorRoomSettingsAccessTabView: FC<NavigatorRoomSettingsTabViewProps> = props =>
{
    ...
    return (
        <>
            <Column gap={ 1 }>
                <Text variant="white" bold>{ LocalizeText('navigator.roomsettings.roomaccess.caption') }</Text>
                <Text variant="white">{ LocalizeText('navigator.roomsettings.roomaccess.info') }</Text>
            </Column>
            <Column overflow="auto">
                <Column gap={ 1 }>
                    <Text variant="white" bold>{ LocalizeText('navigator.roomsettings.doormode') }</Text>
                ...
                <Column gap={ 1 }>
                    <Text variant="white" bold>{ LocalizeText('navigator.roomsettings.pets') }</Text>
                    <Flex alignItems="center" gap={ 1 }>
