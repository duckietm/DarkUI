...
export const NavigatorRoomInfoView: FC<NavigatorRoomInfoViewProps> = props =>
{
    ...
    return (
        <NitroCardView className="nitro-room-info">
                                ...
                                <Flex gap={ 1 }>
                                    <Column grow gap={ 1 }>
                                        <Flex gap={ 1 }>
                                            ...
                                            <Text variant="white"  bold>{ navigatorData.enteredGuestRoom.roomName }</Text>
                                        </Flex>
                                        ...
                                        { (navigatorData.enteredGuestRoom.tags.length > 0) &&
                                            <Flex alignItems="center" gap={ 1 }>
                                                ...
                                                {
                                                    return <Text variant="white"  key={ tag } pointer className="bg-muted rounded p-1" onClick={ event => processAction('navigator_search_tag', tag) }>#{ tag }</Text>
                                                }) }
                                            </Flex> }
                                    </Column>
                                    <Column alignItems="center" gap={ 1 }>
                                        ...
                                        <FaLink style={{color: "white"}} title={ LocalizeText('navigator.embed.caption') } className="cursor-pointer fa-icon" onClick={ event => CreateLinkEvent('navigator/toggle-room-link') } />
                                    </Column>
                                </Flex>
                                <Text variant="white"  overflow="auto" style={ { maxHeight: 50 } }>{ navigatorData.enteredGuestRoom.description }</Text>
