                ...
                <NitroCardView uniqueKey="catalog" className="nitro-catalog" style={ GetConfiguration('catalog.headers') ? { width: 710 } : {} }>
                    ...
                    <NitroCardTabsView>
                        { rootNode && (rootNode.children.length > 0) && rootNode.children.map(child =>
                        {
                            ...
                            return (
                                <NitroCardTabsItemView key={ child.pageId } isActive={ child.isActive && !setIsFavoriteActive ? true : false } onClick={ event =>
                                {
                        ...
                        <NitroCardTabsItemView isActive={ isFavoriteActive } onClick={ event => setIsFavoriteActive(true)} >
                            <Flex gap={ GetConfiguration('catalog.tab.icons') ? 1 : 0 } alignItems="center">
                            Favoritos
                            </Flex>
                        </NitroCardTabsItemView>
