    ...
    return (
        <Column gap={ 1 }>
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="white" className="col-3">{ LocalizeText('catalog.marketplace.sort_order') }</Text>
            ...
            { searchType === MarketplaceSearchType.ADVANCED &&
                <>
                    <Flex alignItems="center" gap={ 1 }>
                        <Text variant="white" className="col-3">{ LocalizeText('catalog.marketplace.search_name') }</Text>
                    ...
                    <Flex alignItems="center" gap={ 1 }>
                        <Text variant="white" className="col-3">{ LocalizeText('catalog.marketplace.search_price') }</Text>
