    ...
    return (
        <NitroCardView uniqueKey="catalog-gift" className="nitro-catalog-gift" theme="primary-slim">
            ...
            <NitroCardContentView className="text-black">
                <FormGroup column>
                    <Text variant="white">{ LocalizeText('catalog.gift_wrapping.receiver') }</Text>
                ...
                <Flex alignItems="center" gap={ 2 }>
                    ...
                    <Column gap={ 1 }>
                        <Flex gap={ 2 }>
                            ...
                            <Column gap={ 1 }>
                                <Text variant="white" fontWeight="bold">{ LocalizeText(boxName) }</Text>
                        ...
                        <Flex alignItems="center" gap={ 2 } className={ isColorable ? '' : 'opacity-50 pointer-events-none' }>
                            ...
                            <Text variant="white" fontWeight="bold">{ LocalizeText(ribbonName) }</Text>
                        </Flex>
                    </Column>
                </Flex>
