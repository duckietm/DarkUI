...
export interface LayoutGridChatProps extends ColumnProps
{
    itemImage?: string;
    itemColor?: string;
    itemActive?: boolean;
...
export const LayoutGridChat: FC<LayoutGridChatProps> = props =>
{
    ...
    {
        const newClassNames: string[] = [ 'layout-grid-item', 'border-muted', 'rounded' ];
